...
class QleverConfig:
            ...
            for arg_name in arg_names[section]:
                ...
                if qleverfile_config is not None:
                    ...
                    if qleverfile_value is not None:
                        ...
                        kwargs_copy["help"] += (
                            f" [default, from Qleverfile: {qleverfile_value}]"
                        )
                    else:
    ...
    def parse_args(self, script_name: str, command_objects: CommandObjects):
        ...
        all_args = Qleverfile.all_arguments(script_name)
