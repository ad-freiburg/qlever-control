...
class TestStartCommand(unittest.TestCase):
    ...
    def test_description(self):
        self.assertEqual("Show how much of the cache is currently being "
                         "used", CacheStatsCommand().description())
    ...
    def test_relevant_qleverfile_arguments(self):
        ...
        self.assertEqual(testdict,
                         CacheStatsCommand().relevant_qleverfile_arguments())
    ...
    def test_additional_arguments(self):
        ...
        self.assertEqual("URL of the QLever server, default is "
                               "localhost:{port}", argument_help)
        ...
        self.assertEqual("Show detailed statistics and settings",
                         argument_help)
